...
// TDD §6 — GPU instancing vertex shader. Identical to pbr_vert.glsl except
...
// Instanced entities are always non-skinned; slot 0 must hold identity.
...
layout(location = 6) in mat4 inInstance;
