...
private:
    ...
    void createOffscreenResources() {
        ...
        imageInfo.format = swapChainImageFormat; // Keep same format as swapchain
        ...
        // Debug: Ensure offscreen image is different from swapchain images
        for (const auto& swapImage : swapChainImages) {
            if (offscreenImage == swapImage) {
                throw std::runtime_error("offscreen image conflicts with swapchain image!");
            }
        }
    ...
    void drawFrame() {
        ...
        uiManager->render(viewportTexture);
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        // Skip the initial barrier - let the render pass handle the layout transition
        ...
        // barrier.image = offscreenImage;  // Make sure this is the correct image
        ...
        // Skip the final barrier for now - may not be needed
        // VkImageMemoryBarrier barrier{};
        // barrier.sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER;
