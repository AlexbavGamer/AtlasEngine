...
VulkanDevice::VulkanDevice() : physicalDevice(VK_NULL_HANDLE), device(VK_NULL_HANDLE) {}

VulkanDevice::~VulkanDevice() {
    cleanup();
}

void VulkanDevice::init(VkInstance instance, VkSurfaceKHR surface, bool enableValidationLayers) {
